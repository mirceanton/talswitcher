...
setup() {
    ...
    echo "========================================================================================="
    TALOSCONFIG=$TALOSCONFIG_DIR/talos1.yaml talosctl cluster create docker --name=talos-cluster-1 --subnet=10.5.0.0/24 --wait=false &
    TALOSCONFIG=$TALOSCONFIG_DIR/talos2.yaml talosctl cluster create docker --name=talos-cluster-2 --subnet=10.6.0.0/24 --wait=false &
    wait
